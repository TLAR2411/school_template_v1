...
<template>
  <AppAddEditDialog
    :title="itemData.id == null ? 'Create Person' : 'Update Person'"
  ...
  >
    <VRow>
      <VCol cols="12" sm="6" md="6">
        <AppTextField v-model="itemData.name_kh" label="Name Khmer" />
      </VCol>
      <VCol cols="12" sm="6" md="6">
        <AppTextField v-model="itemData.name_en" label="Name English" />
      </VCol>
    </VRow>
  </AppAddEditDialog>
</template>
